...
var datos = {
                ...
                42:{
                        "Estación":"Los Amates", "Lat":"16.864", "Long":"-99.86919", "Icono":"ruta-alimentadora-8-paradas.png","Icono_grande":"ruta-alimentadora-8-paradas_g.png",
                        "Conexiones": [
                                {"id": 43, "costo": 2},
                                {"id": 1, "costo": 2},
                                {"id": 144, "costo": 2},
                ...
                68:{
                        "Estación":"17", "Lat":"16.88363", "Long":"-99.8264", "Icono":"ruta-troncal-3-paradas.png","Icono_grande":"ruta-troncal-3-paradas_g.png",
                        "Conexiones": [
                                {"id": 67, "costo": 1},
                                {"id": 69, "costo": 1},
                        ],
                ...
                75:{
                        "Estación":"10", "Lat":"16.86917", "Long":"-99.81162", "Icono":"ruta-troncal-3-paradas.png","Icono_grande":"ruta-troncal-3-paradas_g.png",
                        "Conexiones": [
                                {"id": 74, "costo": 1},
                                {"id": 76, "costo": 1},
                        ],
                ...
                81:{
                        "Estación":"4", "Lat":"16.8495", "Long":"-99.81588", "Icono":"ruta-troncal-3-paradas.png","Icono_grande":"ruta-troncal-3-paradas_g.png",
                        "Conexiones": [
                                {"id": 80, "costo": 1},
                                {"id": 82, "costo": 1},
                        ],
                ...
                106:{
                        "Estación":"Circuito", "Lat":"16.90004", "Long":"-99.81595", "Icono":"ruta-alimentadora-2-paradas.png","Icono_grande":"ruta-alimentadora-2-paradas_g.png",
                        "Conexiones": [
                                {"id": 105, "costo": 1},
                                {"id": 107, "costo": 1}
                        ],
                ...
                159:{
                        "Estación":"Sonora", "Lat":"16.86181", "Long":"-99.89371", "Icono":"ruta-alimentadora-10-paradas.png","Icono_grande":"ruta-alimentadora-10-paradas_g.png",
                        "Conexiones": [
                                {"id": 158, "costo": 1},
                                {"id": 160, "costo": 1},
                        ],
                ...
                161:{
                        "Estación":"Bernal Díaz del Castillo", "Lat":"16.86878", "Long":"-99.89822", "Icono":"ruta-alimentadora-11-paradas.png","Icono_grande":"ruta-alimentadora-11-paradas_g.png",
                        "Conexiones": [
                                {"id": 54, "costo": 2},
                                {"id": 162, "costo": 1},
                        ],
                ...
                203:{
                        "Estación":"Guadalupe Victoria", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RT1"
                        ]                        
                },
                204:{
                        "Estación":"La Cima", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RT1"
                        ]                        
                },
                205:{
                        "Estación":"Puente 1º de Mayo", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RT1"
                        ]                        
                },
                206:{
                        "Estación":"Puente Juan Aldama", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RT1"
                        ]                        
                },
                207:{
                        "Estación":"Puente La Tolva", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RT1"
                        ]                        
                },
                208:{
                        "Estación":"Ignacio Zaragoza", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RT1"
                        ]                        
                },
                209:{
                        "Estación":"Los Lirios", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RT1"
                        ]                        
                },
                210:{
                        "Estación":"Puente Niños Héroes", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RT1"
                        ]                        
                },
                211:{
                        "Estación":"Av. Universidad", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RT4","RA8"
                        ]                        
                },
                212:{
                        "Estación":"Acuario", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RA6"
                        ]                        
                },
                213:{
                        "Estación":"20 de Noviembre", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RA6"
                        ]                        
                },
                214:{
                        "Estación":"Bodega Comercial M.", "Lat":"", "Long":"", "Icono":"","Icono_grande":"",
                        "Rutas": [
                        "RA8"
                        ]                        
                },
...
function agregaRuta(ruta){
	...
	for(var i = 0; i < ruta.length; i++){
		...
		if(est1 == undefined || est2 == undefined){
			if(est1 == undefined){
                console.log('No esta: '+ruta[i]);
                return false;
            }
            if(est2 == undefined){
                console.log('No esta: '+ruta[i+1]);
                return false;
            }
            return false;
		}
...
var arista = getArista('Zócalo | Oviedo-RT2', 'Zócalo | Oviedo-RT1');
aristas.append(arista);
var arista = getArista('Zócalo | Oviedo-RT1', 'Zócalo | Oviedo-RT3');
aristas.append(arista);
var arista = getArista('Zócalo | Oviedo-RT3', 'Zócalo | Oviedo-RT4');
aristas.append(arista);

var arista = getArista('Melchor Ocampo-RT2', 'Melchor Ocampo-RT1');
aristas.append(arista);
var arista = getArista('Melchor Ocampo-RT1', 'Melchor Ocampo-RT3');
aristas.append(arista);
var arista = getArista('Melchor Ocampo-RT3', 'Melchor Ocampo-RT4');
aristas.append(arista);


var arista = getArista('Seguro Social-RT2', 'Seguro Social-RT1');
aristas.append(arista);
var arista = getArista('Seguro Social-RT1', 'Seguro Social-RT3');
aristas.append(arista);
var arista = getArista('Seguro Social-RT3', 'Seguro Social-RT4');
aristas.append(arista);

var arista = getArista('Cine Río-RT2', 'Cine Río-RT1');
aristas.append(arista);
var arista = getArista('Cine Río-RT1', 'Cine Río-RT3');
aristas.append(arista);
var arista = getArista('Cine Río-RT3', 'Cine Río-RT4');
aristas.append(arista);

var arista = getArista('Flores Magón-RA10', 'Flores Magón-RT2');
aristas.append(arista);
var arista = getArista('Flores Magón-RT2', 'Flores Magón-RT1');
aristas.append(arista);
var arista = getArista('Flores Magón-RT1', 'Flores Magón-RT3');
aristas.append(arista);
var arista = getArista('Flores Magón-RT3', 'Flores Magón-RT4');
aristas.append(arista);


var arista = getArista('Michoacán-RA10', 'Michoacán-RT2');
aristas.append(arista);
var arista = getArista('Michoacán-RT2', 'Michoacán-RT1');
aristas.append(arista);
var arista = getArista('Michoacán-RT1', 'Michoacán-RT3');
aristas.append(arista);
var arista = getArista('Michoacán-RT3', 'Michoacán-RT4');
aristas.append(arista);


var arista = getArista('Palacio Municipal-RT2', 'Palacio Municipal-RT1');
aristas.append(arista);
var arista = getArista('Palacio Municipal-RT1', 'Palacio Municipal-RT3');
aristas.append(arista);
var arista = getArista('Palacio Municipal-RT3', 'Palacio Municipal-RT4');
aristas.append(arista);


var arista = getArista('Las Anclas-RT2', 'Las Anclas-RT1');
aristas.append(arista);
var arista = getArista('Las Anclas-RT1', 'Las Anclas-RT3');
aristas.append(arista);
var arista = getArista('Las Anclas-RT3', 'Las Anclas-RA8');
aristas.append(arista);
...
console.log('Hasta ' + b.data['nombre'] + ", Ruta: " + b.data['ruta']);
